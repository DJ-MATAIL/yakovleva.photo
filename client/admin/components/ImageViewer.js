...
import {
    clearImagesFromImageViewerImagesList as clearImagesFromImageViewerImagesListAction,
    setCurrentImageOfImageViewer         as setCurrentImageOfImageViewerAction
} from '../actions/image-viewer'
import { hideImageViewer as hideImageViewerAction } from '../actions/layers'
import {
    ESCAPE,
    RIGHT_ARROW,
    LEFT_ARROW
...
export default function ImageViewer() {
    ...
    const clearImagesFromImageViewerImagesList = () => dispatch(clearImagesFromImageViewerImagesListAction())
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            clearImagesFromImageViewerImagesList()
        }
    }, [])
